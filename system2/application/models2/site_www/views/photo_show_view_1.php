...
<!-- 主体 -->
<section class="contentbox10">
  <div class="content_main">
    <div class="search_box">
      <a class="list_back fl" style="padding-left:70px;width:700px; text-align:left;" href="<?php echo $site_url;?>photo"><?php echo $page_info-><field_title>;?><span><img src="<?php echo $base_url;?>resource/site_yn/images/arrow01-1.png" /></span></a>
      <div class="clear"></div>
    </div><!--search_box END-->
    <article class="essay_box" style="padding-top:30px;">
      <menu class="video_share example_share">
        <a class="a1" href="#">我要分享</a>
        <a class="a2" href="javascript:;" onclick="showbuild()" ><span>0</span>评论</a>
        <div class="clear"></div>
      </menu>
     <?php echo $page_info-><field_content>;?>
      <a class="example_lj" href="http://www.zctea.cn" title="<?php echo $page_info-><field_title>;?>" target="_blank">浏览网站：http://www.zctea.cn</a>
    </article>
    <div class="clear"></div>
    ...
    </table><!--content_botbox END--><!--content_botbox END-->
  </div><!--main END-->
  <div class="clear"></div>
