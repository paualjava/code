...
function formCheck()
{
    ...
    <article class="essay_box">
      <menu class="video_share" style="top:50px;">
        <a class="a1" href="#">我要分享</a>
        <a class="a2" href="javascript:;" onclick="showbuild()" ><span>0</span>评论</a>
      </menu>
      <h2><?php echo $page_info-><field_title>;?></h2>
      <h3><?php echo get_time($page_info-><field_postdate>);?>/ 人气<?php echo $page_info-><column_name_first>;?></h3>
      <p><?php echo $page_info-><field_content>;?></p>
    </article>
    <div class="clear"></div>
