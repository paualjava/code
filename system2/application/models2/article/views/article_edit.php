 ...
 <form action="" method="post" enctype="multipart/form-data" class="cmxform" id="post_form" onsubmit="return add_submit()">
    <table width="95%" border="0" cellpadding="1" cellspacing="1"  class="proa_table_class">
      <tr>
        ...
        <td>  <input name="title" id="title" type="text" class="input1" style="width:400px;height:20px;" value="<?php echo $this_data->subject; ?>"/> &nbsp; <a href="<?php echo $web_url;?>/admin_admin/index/manager/article/<?php echo $current;?>"><img src="<?php echo $base_url;?>resource/images/admin_admin/return.gif" border="0" align="absmiddle"/> 返回</a>
        <input type="hidden" name="id" id="id" value="<?php echo $id;?>"/>
        <input name="current" type="hidden" id="current"  value="<?php echo $current;?>"/></td>
      </tr>
        <tr>
	   ...
	   <?php echo $category;?>
         ...
         <tr>
        <td>文章内容</td>
        <td>        <textarea name="page_text"><?php echo $page_text;?></textarea>
    <script type="text/javascript">
...
filebrowserFlashUploadUrl : '<?php echo $base_url;?>resource/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
         ...
         <tr>
        <td> </td>
        <td> <input type="submit" value="提交" class="submitBtn"/> &nbsp; <a href="<?php echo $web_url;?>/admin_admin/index/manager/article/<?php echo $current;?>"><img src="<?php echo $base_url;?>resource/images/admin_admin/return.gif" border="0" align="absmiddle"/> 返回</a></td>
      </tr>
    </table>
