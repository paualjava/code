...
?>
    <tr class="<?php echo $increment;?>">
      ...
      <td>&nbsp;<a href="<?php echo $site_url;?><?php echo $row->url;?>" target="_blank"><img src="<?php echo $base_url;?>resource/images/admin_admin/icon_3.gif" border="0"/></a> &nbsp; <a href="<?php echo $admin_url;?><?php echo $row->url;?>" target="_blank" style="color:#<?php echo $color_url;?>"><img src="<?php echo $base_url;?>resource/images/admin_admin/bian_01.gif" border="0"/></a> &nbsp;
